package com.netease.course.tools;
...
public class ConnDB {
	...
	private static String doUrl = "jdbc.url =jdbc:mysql://localhost:3306/shop";
	...
	public static Connection getConnection() {
		...
		try {// 捕捉异常
			...
			conn = DriverManager.getConnection(doUrl, dbUser, dbPwd);// 获取数据库连接对象
