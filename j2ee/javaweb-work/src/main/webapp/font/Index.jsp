...
<jsp:useBean id="conn" scope="page" class="com.netease.course.tools.ConnDB"></jsp:useBean>
<%
	ResultSet rs_new = conn.executeQuery("select title,price,icon from content");
	String title = "";
	float price = 0;
	byte[] icon = null;
%>
...
<%
	while(rs_new.next()){
		title = rs_new.getString(1);
		price = rs_new.getFloat(2);
		icon = rs_new.getBytes(3);
	}
